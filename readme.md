...
​	上面的配置等效于：/team modify 1 prefix {"text":"[你好] ","color":"red","bold":true} 显示效果为：<font color=red>**[星期六]**</font> playerName
...
1. ##### 在应用此插件前，最好将该服内所有的team信息清除，以防冲突

2. ##### 此插件由于修改了玩家名称格式，所以不能被默认的 ```vanilla_handler``` 处理，需要手动改修改适配
